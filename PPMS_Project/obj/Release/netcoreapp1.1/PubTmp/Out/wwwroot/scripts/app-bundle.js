define('actual_cost',["exports"], function (exports) {
    "use strict";
    ...
    var actual_cost = exports.actual_cost = function actual_cost() {
...
define('app',['exports', 'aurelia-framework', 'toastr', 'bootstrap'], function (exports, _aureliaFramework, _toastr) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_toastr2.default), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'PPMS';
      config.map([{ route: ['', 'mainview'], name: 'mainview', moduleId: 'mainview', nav: true, title: 'Budget Template' }, { route: 'group_individual', name: 'group_individual', moduleId: 'group_individual', nav: true, title: 'Talent Groups' }, { route: 'actual_cost', name: 'actual_cost', moduleId: 'actual_cost', nav: true, title: 'Actual Cost' }, { route: 'buh', name: 'buh', moduleId: 'buh', nav: true, title: 'BUH' }]);
...
define('buh',['exports', './entity-manager-factory', './helpers', './masterfiles', 'toastr', 'aurelia-framework', 'helpers', 'typeahead', 'underscore', 'modals/buh-program-dialog', 'aurelia-dialog', 'modals/login', 'modals/buh-search', 'objBudget'], function (exports, _entityManagerFactory, _helpers, _masterfiles, _toastr, _aureliaFramework, _helpers2, _typeahead, _underscore, _buhProgramDialog, _aureliaDialog, _login, _buhSearch, _objBudget) {
	...
	var buh = exports.buh = (_dec = (0, _aureliaFramework.inject)(_objBudget.objBudget, _aureliaDialog.DialogService), _dec(_class = function () {
		function buh(objBudget, DialogService) {
			...
			_toastr2.default.success("Loading Programs", "Loading");

			(0, _entityManagerFactory.initializeBreeze)().then(function () {

				var _query = (0, _entityManagerFactory.EntityQuery)().from('PROGRAM_MSTR').where(breeze.Predicate.and(_this.currPredicate)).select('PROGRAM_CD,PROGRAM_TITLE,PROGRAM_ID,BUH_PERSONNEL_ID');
				...
				setTimeout(function () {
					...
					if ((0, _helpers.checkCookie)("PPMS_USER") == "" || (0, _helpers.checkCookie)("PPMS_USER") == undefined || (0, _helpers.checkCookie)("PPMS_USER").indexOf('undefined') >= 0) {
						_this.fnLogin();
						_this.loginDisabled = false;
						_this.logoutDisabled = true;
						return;
					}
						...
						if (varDelete) {
							...
							for (var i = this._objBUH.PROGRAMS.length - 1; i >= 0; i--) {
								var found = this._programs.find(function (all) {
									return all.PROGRAM_CD == _this2._objBUH.PROGRAMS[i].PROGRAM_CD;
								});
		...
		buh.prototype.saveBUH = function saveBUH() {
			...
			if (this._status == "view") {
				...
				(0, _entityManagerFactory.EntityManager)().executeQuery(getBUHForEdit).then(function (success) {
					...
					success.results[0].OPTIONAL_GLOBAL_ID = _this3._objBUH.OPTIONAL_GLOBAL_ID.toUpperCase();
					success.results[0].FIRST_NAME = _this3._objBUH.FIRST_NAME.toUpperCase();
					success.results[0].MIDDLE_NAME = _this3._objBUH.MIDDLE_NAME.toUpperCase();
					success.results[0].LAST_NAME = _this3._objBUH.LAST_NAME.toUpperCase();
					success.results[0].EMAIL_ADDRESS = _this3._objBUH.EMAIL_ADDRESS.toUpperCase();

					(0, _entityManagerFactory.EntityManager)().saveChanges().then(function (success) {

						_toastr2.default.success("Succesfully Saved", "New Business Unit Head");

						_this3._disableDelete = false;
						_this3._disableGrid = false;
						_this3._disableAdd = false;
						_this3._disableSearch = false;
						_this3._disableCells = false;
						_this3._disableSave = false;
					}, function (fail) {
			...
			(0, _entityManagerFactory.EntityManager)().executeQuery(getMax).then(function (successMax) {
				...
				var varInsert = (0, _entityManagerFactory.EntityManager)().createEntity('BUH_PERSONNEL', {
					...
					OPTIONAL_GLOBAL_ID: _this3._objBUH.OPTIONAL_GLOBAL_ID.toUpperCase(),
					FIRST_NAME: _this3._objBUH.FIRST_NAME.toUpperCase(),
					MIDDLE_NAME: _this3._objBUH.MIDDLE_NAME.toUpperCase(),
					LAST_NAME: _this3._objBUH.LAST_NAME.toUpperCase(),
					EMAIL_ADDRESS: _this3._objBUH.EMAIL_ADDRESS.toUpperCase(),
					CREATED_BY: "PAULV",
				...
				(0, _entityManagerFactory.EntityManager)().saveChanges().then(function (success) {
					...
					_this3._objBUH.BUH_PERSONNEL_ID = getMax;
		...
		buh.prototype.deleteSelected = function deleteSelected(index) {
			...
			if (varDelete) {
				...
				var found = this._programs.find(function (all) {
					return all.PROGRAM_CD == _this4._objBUH.PROGRAMS[index].PROGRAM_CD;
				});
				found.BUH_PERSONNEL_ID = 0;
		...
		buh.prototype.searchExistingBuh = function searchExistingBuh() {
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					_this5.searchBUH(response.output);
					_this5._disableGrid = false;
					_this5._disableDelete = false;
					_this5._disableSave = false;
					_this5._disableCells = false;
				} else {
					_this5._disableSearch = false;
					_this5._disableAdd = false;
				}
			});
		};
		...
		buh.prototype.searchBUH = function searchBUH(item) {
			...
			if (found !== undefined) found.forEach(function (foundItems) {
				_this6._objBUH.PROGRAMS.push(foundItems);
			});
		};
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					...
					for (var a = response.output.length - 1; a >= 0; --a) {
						var found = _this7._programs.find(function (all) {
							return all.PROGRAM_CD == response.output[a].PROGRAM_CD;
						});
						console.log(found.BUH_PERSONNEL_ID);
						if (found.BUH_PERSONNEL_ID == 0) {
							_this7._objBUH.PROGRAMS.push(response.output[a]);
							found.BUH_PERSONNEL_ID = _this7._objBUH.BUH_PERSONNEL_ID;
						} else {
			...
			if (this.masterFilesLoaded == false) {
				...
				(0, _masterfiles.loadMasterfiles)().then(function () {
					(0, _masterfiles.loadLookups)().then(function () {
						...
						_this8._objBudget.OBSERVERS.init_modal.forEach(function (all) {
							all();
						});

						_this8.masterFilesLoaded = true;

						_this8.fnPassUserObject(initType, output);
					});
				});
			} else {
		...
		buh.prototype.fnLogin = function fnLogin() {
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					_this9.fnInitMasterfiles(1, response.output);
				} else {}
			});
		};
...
define('group_individual',['exports', './helpers', './entity-manager-factory', './masterfiles', 'toastr', 'aurelia-framework', 'helpers', 'typeahead', 'underscore', 'multi-observer', 'objBudget', 'aurelia-dialog', 'modals/login', 'modals/globalindivmstr', 'modals/talentmanagergroups'], function (exports, _helpers, _entityManagerFactory, _masterfiles, _toastr, _aureliaFramework, _helpers2, _typeahead, _underscore, _multiObserver, _objBudget, _aureliaDialog, _login, _globalindivmstr, _talentmanagergroups) {
	'use strict';
	...
	var group_individual = exports.group_individual = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _objBudget.objBudget, _aureliaDialog.DialogService), _dec(_class = function () {
		...
		group_individual.prototype.findTalent = function findTalent() {
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					...
					var tmpgrpMembers = _this2.grpMembers;
					var varExists = false;
					response.output.forEach(function (val) {
						...
						if (!varExists) {
							tmpgrpMembers.push({
								...
								GLOBAL_GRP_ID: _this2._GLOBAL_GRP_ID,
					...
					_this2.grpMembers = tmpgrpMembers;

					_this2._signal = (0, _entityManagerFactory.generateID)();
				} else {}
			});
		};
		...
		group_individual.prototype.findTalentManager = function findTalentManager() {
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					...
					_this3._GLOBAL_GRP_ID = response.output.GLOBAL_GRP_ID;
					_this3._GROUP_NAME = response.output.GROUP_NAME;

					_this3.getGlobalIndivsFromGrpIndiv();

					_this3.disabledfindTalent = false;
					_this3.isDisableSave = false;
				} else {}
			});
		};
			...
			if (this.masterFilesLoaded == false) {
				...
				(0, _masterfiles.loadMasterfiles)().then(function () {
					(0, _masterfiles.loadLookups)().then(function () {
						...
						_this4._objBudget.OBSERVERS.init_modal.forEach(function (all) {
							all();
						});

						_this4.masterFilesLoaded = true;

						_this4.fnPassUserObject(initType, output);
					});
				});
			} else {
				this.fnPassUserObject(initType, output);
		...
		group_individual.prototype.fnLogin = function fnLogin() {
			...
			this.dialogService.open({
				...
				if (!response.wasCancelled) {
					_this5.fnInitMasterfiles(1, response.output);
				} else {}
			});
		};
		...
		group_individual.prototype.saveGroupIndiv = function saveGroupIndiv() {
			...
			(0, _entityManagerFactory.EntityManager)().executeQuery(getQueryEntities).then(function (successEnties) {
				...
				(0, _entityManagerFactory.EntityManager)().executeQuery(getMax).then(function (successMax) {
					...
					_this7.grpMembers.forEach(function (indiv) {
						...
						if (indiv.GRP_INDIV_ID === undefined) {
							...
							var varInsert = (0, _entityManagerFactory.EntityManager)().createEntity('GRP_INDIV_MSTR', {
								...
								CREATED_BY: _this7._user.USER_ID,
								STATUS_CD: "ACTV",
								CREATED_DT: new Date(Date.now()),
								GRP_INDIV_ID: getMax
							});
							...
							successEnties.results.forEach(function (existingIndiv) {
								if (existingIndiv.GLOBAL_INDIV_ID == indiv.GLOBAL_INDIV_ID) {
									if (indiv.STATUS_CD == "INACTV" && existingIndiv.STATUS_CD != "INACTV") {
										...
										existingIndiv.LAST_UPDATED_BY = _this7._user.USER_ID;
					...
					(0, _entityManagerFactory.EntityManager)().saveChanges().then(function (success) {
						...
						setTimeout(function () {
							_this7.getGlobalIndivsFromGrpIndiv();
						}, 1000);
					}, function (fail) {
						console.log(fail);
						_toastr2.default.error("Error Occured", fail);
...
define('guest',['exports', 'aurelia-framework', 'objBudget', './entity-manager-factory', './masterfiles', 'helpers', 'typeahead', './settings', 'underscore', 'numeral', 'toastr', 'multi-observer', 'modals/paymentterm', 'aurelia-dialog'], function (exports, _aureliaFramework, _objBudget, _entityManagerFactory, _masterfiles, _helpers, _typeahead, _settings, _underscore, _numeral, _toastr, _multiObserver, _paymentterm, _aureliaDialog) {
  ...
  var GuestCustomElement = exports.GuestCustomElement = (_dec = (0, _aureliaFramework.inject)(_objBudget.objBudget, _multiObserver.MultiObserver, _aureliaDialog.DialogService), _dec(_class = (_class2 = function () {
    function GuestCustomElement(objBudget, multiObserver, dialogService) {
      ...
      this._objBudget = objBudget;
      this.dialogService = dialogService;
      this._objBudget.OBSERVERS.login_passed.push(function () {
        _this.LoginPassed();
      });
    ...
    GuestCustomElement.prototype.LoginPassed = function LoginPassed() {
...
define('main-header',['exports', 'aurelia-framework', 'objBudget', './entity-manager-factory', './masterfiles', './settings', 'modals/modal-wizard', 'toastr', 'moment', 'underscore', 'multi-observer', 'aurelia-dialog', 'modals/program', 'modals/budget', 'modals/confirm_dialog', 'breeze-client'], function (exports, _aureliaFramework, _objBudget, _entityManagerFactory, _masterfiles, _settings, _modalWizard, _toastr, _moment, _underscore, _multiObserver, _aureliaDialog, _program, _budget, _confirm_dialog, _breezeClient) {
  ...
  var MainHeaderCustomElement = exports.MainHeaderCustomElement = (_dec = (0, _aureliaFramework.inject)(_objBudget.objBudget, _modalWizard.ModalWizard, _toastr2.default, _multiObserver.MultiObserver, _aureliaDialog.DialogService), _dec(_class = (_class2 = function () {
    function MainHeaderCustomElement(objBudget, ModalWizard, toastr, multiObserver, DialogService) {
      ...
      this._objBudget.OBSERVERS.login_passed.push(function (val) {
        _this.LoginPassed(val);
      });

      this._objBudget.OBSERVERS.loggedout.push(function () {
        _this.LoggedOut();
      });
...
define('mainview',['exports', 'aurelia-framework', 'objBudget', './entity-manager-factory', './masterfiles', 'toastr', 'aurelia-dialog', './helpers', 'multi-observer', 'modals/login'], function (exports, _aureliaFramework, _objBudget, _entityManagerFactory, _masterfiles, _toastr, _aureliaDialog, _helpers, _multiObserver, _login) {
  'use strict';
  ...
  var mainview = exports.mainview = (_dec = (0, _aureliaFramework.inject)(_toastr2.default, _objBudget.objBudget, _multiObserver.MultiObserver, _aureliaDialog.DialogService), _dec(_class = function () {
    function mainview(toastr, objBudget, multiObserver, dialogService) {
      var _this = this;
    ...
    mainview.prototype.fnInitMasterfiles = function fnInitMasterfiles(initType, output) {
      var _this2 = this;
      ...
      if (this.masterFilesLoaded == false) {
        ...
        (0, _masterfiles.loadMasterfiles)().then(function () {
          (0, _masterfiles.loadLookups)().then(function () {
            ...
            _this2._objBudget.OBSERVERS.init_modal.forEach(function (all) {
              all();
            });
    ...
    mainview.prototype.fnPassUserObject = function fnPassUserObject(initType, output) {
      var _this3 = this;
      ...
      if (initType == 1) {} else {
        ...
        this._objBudget.OBSERVERS.login_passed.forEach(function (all) {
          all(_this3._user);
        });
  ...
  function getJOB_GRP_CATEGORY() {
    ...
    varTmpObject.forEach(function (all) {
      ...
      var varFindCategory = p_category.find(function (allCategory) {
        return allCategory.CATEGORY_CD == all.JOB_GRP_CD;
      });
...
define('personnel',['exports', 'aurelia-framework', 'objBudget', './entity-manager-factory', './masterfiles', 'helpers', 'typeahead', './settings', 'underscore', 'modals/modal-wizard', 'numeral', 'multi-observer', 'toastr', 'modals/globalindivmstr', 'modals/indivmstr', 'modals/job', 'modals/paymentterm', 'aurelia-dialog', 'breeze-client'], function (exports, _aureliaFramework, _objBudget, _entityManagerFactory, _masterfiles, _helpers, _typeahead, _settings, _underscore, _modalWizard, _numeral, _multiObserver, _toastr, _globalindivmstr, _indivmstr, _job, _paymentterm, _aureliaDialog, _breezeClient) {
  ...
  var PersonnelCustomElement = exports.PersonnelCustomElement = (_dec = (0, _aureliaFramework.inject)(_objBudget.objBudget, _modalWizard.ModalWizard, _multiObserver.MultiObserver, _aureliaDialog.DialogService), _dec(_class = (_class2 = function () {
    ...
    PersonnelCustomElement.prototype.LoginPassed = function LoginPassed() {
      var _this2 = this;

      this._PYMNTTERM = (0, _masterfiles.getLookups)().PAYMENT_TERM;

      this._JOBS = (0, _masterfiles.getLookups)().JOB_GRP_CATEGORY.filter(function (all) {
        return all.COMPANY_ID == _this2._objBudget.USER.COMPANY_ID;
      });
    };
    ...
    PersonnelCustomElement.prototype.passJob = function passJob(job) {
      ...
      var varGrpCategory = (0, _masterfiles.getLookups)().JOB_GRP_CATEGORY.find(function (all) {
        return all.JOB_ID == _this3._Personnel[index].JOB_ID && all.COMPANY_ID == _this3._objBudget.USER.COMPANY_ID;
      });
    ...
    PersonnelCustomElement.prototype.onSpeculateProp = function onSpeculateProp(newValue, oldValue) {
      ...
      this._Personnel.forEach(function (all) {
        ...
        if (_this4._personnelSearch.toUpperCase() !== "") {
          if (all['PERSONNEL_NAME'] !== undefined && all['PERSONNEL_NAME'] != null) if (!all['PERSONNEL_NAME'].toUpperCase().includes(_this4._personnelSearch.toUpperCase())) {
            all.visible = false;
          }

          if (all['BLANK_PERSONNEL_NAME'] !== undefined && all['PERSONNEL_NAME'] != null) if (!all['BLANK_PERSONNEL_NAME'].toUpperCase().includes(_this4._personnelSearch.toUpperCase())) {
            all.visible = false;
          }
        }
      });
    ...
    PersonnelCustomElement.prototype.collapse_expand_head = function collapse_expand_head() {
      ...
      if (this._ce_head == "+") {
        ...
        this._Personnel.forEach(function (item) {
          item.ce_value = "-";
          item.styleString = _this5.styleStringVisible;
        });
      } else {
        this._ce_head = "+";
        this._Personnel.forEach(function (item) {
          item.ce_value = "+";
          item.styleString = _this5.styleStringHidden;
        });
      }
    };
    ...
    PersonnelCustomElement.prototype.ButtonStatus = function ButtonStatus(value) {
      ...
      this._objBudget.OBSERVERS.enable_modal_button.forEach(function (all) {
        _this6.isIndivMstrDisabled = !value;
        _this6.isIndivMstrTalentsDisabled = !value;
      });
    };
    ...
    PersonnelCustomElement.prototype.fnCheckBudget = function fnCheckBudget(BDGT_TMPL_ID) {
      ...
      this._objBudget.OBSERVERS.enable_modal_button.forEach(function (all) {
        _this7.isIndivMstrDisabled = false;
        _this7.isIndivMstrTalentsDisabled = false;
      });
      ...
      (0, _entityManagerFactory.EntityManager)().executeQuery(_query).then(function (found) {
        ...
        _this7._Personnel.splice(0, _this7._Personnel.length);
        _this7._PersonnelTM.splice(0, _this7._PersonnelTM.length);

        found.results.forEach(function (item) {

          _this7._Personnel.push({
            BDGT_TMPL_DTL_ID: item.BDGT_TMPL_DTL_ID,
            BDGT_TMPL_ID: _this7._objBudget.HEADER.BDGT_TMPL_ID,
            JOB_ID: item.JOB_ID,
            ...
            TAPING_DAY_CNT: _this7._objBudget.HEADER.TAPING_DAYS,
        ...
        if (_this7.toPersonModel.USE == "REGULAR") {

          _this7._objBudget.REGULAR = _this7._Personnel;

          if (_this7._objBudget.REGULAR.length > 0) _toastr2.default.success("REGULAR PERSONNEL", "Loading Successful.");

          _this7.setPersonnelValues(_this7._objBudget.REGULAR, varJobLength, varCategoryLength);
        } else if (_this7.toPersonModel.USE == "SEMI_REGULAR") {

          varPsClType = "Semi-Regular";

          _this7._objBudget.SEMI_REGULAR = _this7._Personnel;

          if (_this7._objBudget.SEMI_REGULAR.length > 0) _toastr2.default.success("SEMI-REGULAR PERSONNEL", "Loading Successful.");

          _this7.setPersonnelValues(_this7._objBudget.SEMI_REGULAR, varJobLength, varCategoryLength);
        } else if (_this7.toPersonModel.USE == "STAFF") {

          varPsClType = "Staff";

          _this7._objBudget.STAFF = _this7._Personnel;

          if (_this7._objBudget.STAFF.length > 0) _toastr2.default.success("STAFF PERSONNEL", "Loading Successful.");

          _this7.setPersonnelValues(_this7._objBudget.STAFF, varJobLength, varCategoryLength);
        }

        _this7._signal = (0, _entityManagerFactory.generateID)();

        _this7._objBudget.OBSERVERS.reset_summary.forEach(function (all) {
    ...
    PersonnelCustomElement.prototype.setPersonnelValues = function setPersonnelValues(obj, varJobLength, varCategoryLength) {
      ...
      _underscore2.default.each(obj, function (item) {
        ...
        for (var i = 0; i <= _this8._PYMNTTERM.length - 1; ++i) {
          if (_this8._PYMNTTERM[i].REF_CD == item.PYMNT_TERM_CD) {
            item.PAYMENT_TERM = _this8._PYMNTTERM[i].REF_DESC;
            break;
          }
        };
        ...
        item.styleString = _this8.styleStringHidden;
        item.ce_value = "+";
        item.visible = true;
      });
    ...
    PersonnelCustomElement.prototype.removeTalent = function removeTalent(parent, item, index) {
      ...
      this._Personnel.forEach(function (all) {
        if (all.GLOBAL_ID == item.GLOBAL_INDIV_ID) {
          ...
          _this9._signal = (0, _entityManagerFactory.generateID)();
        }
      });
    };
    ...
    PersonnelCustomElement.prototype.scrollDiv = function scrollDiv() {
      ...
      _underscore2.default.each($(this.tblData).find('td'), function (item) {
        if (varCol > $(_this10.tblHeader).find('td').length - 2) return;

        $($(_this10.tblHeader).find('td')[varCol]).css("width", $(_this10.tblData).find('td')[varCol].clientWidth + 1);
        ++varCol;
      });
    };
    ...
    PersonnelCustomElement.prototype.showTalents = function showTalents(item) {
      ...
      this._objBudget.OBSERVERS.open_modal.forEach(function (all) {
        _this11.isIndivMstrTalentsDisabled = false;
      });
    };
    ...
    PersonnelCustomElement.prototype.fnPassedPersonnels = function fnPassedPersonnels(value) {
      ...
      this._Personnel.forEach(function (all) {
        ...
        all.ce_value = "+";
        all.styleString = _this12.styleStringHidden;
      });
      ...
      this._Personnel.forEach(function (all) {
        ...
        if (varIndiv !== undefined) {
          ...
          if (parseInt(varJobTManager.COMPANY_ID) != parseInt(_this12._objBudget.USER.COMPANY_ID)) {
            _toastr2.default.error(varJobTManager.JOB_DESC + "Job is not included on jobs from users company.", "Problem occured");
            varJobTManager.JOB_ID = "";
            varJobTManager.JOB_DESC = "";
          }
    ...
    PersonnelCustomElement.prototype.PassedGroup = function PassedGroup(value) {
      ...
      if (this.modalIndivMstrTalents.id == this._ModalWizard.ids[this._ModalWizard.ids.length - 1]) {
        ...
        this._selectedItem.TALENTS.forEach(function (all) {
          if (_this13._Personnel.find(function (allReg) {
            return allReg.GLOBAL_ID == all.GLOBAL_INDIV_ID;
          }) === undefined) {

            var varJob = (0, _masterfiles.getJobByGlobalCompany)(all.GLOBAL_INDIV_ID);

            if (parseInt(varJob.COMPANY_ID) != parseInt(_this13._objBudget.USER.COMPANY_ID)) {
              _toastr2.default.error(varJob.JOB_DESC + " Job is not included on jobs from users company.", "Problem occured");
              varJob.JOB_ID = "";
              varJob.JOB_DESC = "";
            }
            ...
            _this13._Personnel.push({
              ...
              STAFF_WORK_TMP: false,
              CONFIDENTIAL_TMP: false,
              GLOBAL_ID_LINK: _this13._selectedItem.GLOBAL_ID,
              TALENT_MANAGER: {
                GLOBAL_INDIV_ID: _this13._selectedItem.GLOBAL_ID,
                PERSONNEL_NAME: _this13._selectedItem.PERSONNEL_NAME
              }
            });
          }
        });
    ...
    PersonnelCustomElement.prototype.savePersonnel = function savePersonnel(tag) {
        ...
        for (var j = 0; j <= this._Personnel.length - 1; ++j) {
          ...
          if (this._Personnel[j].GROUP_ORDER !== -1 && this._Personnel[i].GROUP_ORDER !== -1) {
            if (this._Personnel[j].PERSONNEL_NAME == this._Personnel[i].PERSONNEL_NAME && this._Personnel[j].JOB_ID == this._Personnel[i].JOB_ID && i != j && varDuplicateValidation.find(function (all) {
              return all == _this14._Personnel[j].PERSONNEL_NAME;
      ...
      (0, _entityManagerFactory.EntityManager)().executeQuery(getMax).then(function (successMax) {
        ...
        var getAllDtl = (0, _entityManagerFactory.EntityQuery)().from('BDGT_TMPL_DTL').where("BDGT_TMPL_ID", '==', _this14._objBudget.HEADER.BDGT_TMPL_ID);
        (0, _entityManagerFactory.EntityManager)().executeQuery(getAllDtl).then(function (foundDtl) {

          _this14._Personnel.forEach(function (item) {
          ...
          _this14._Personnel.forEach(function (item) {
            ...
            if (item.BDGT_TMPL_DTL_ID === undefined && item.GROUP_ORDER !== -1) {
              ...
              var varInsert = (0, _entityManagerFactory.EntityManager)().createEntity('BDGT_TMPL_DTL', {
                ...
                BDGT_TMPL_ID: _this14._objBudget.HEADER.BDGT_TMPL_ID,
                JOB_ID: item.JOB_ID,
                GLOBAL_ID: item.GLOBAL_ID,
                ...
                TAPING_DAY_CNT: _this14._objBudget.HEADER.TAPING_DAYS,
                PERSONNEL_CLASS_CD: _this14.toPersonModel.USE != "STAFF" ? "Mainstay" : "Staff",
                REMARKS: item.REMARKS,
                PERSONNEL_INFO_SRC: item.PERSONNEL_INFO_SRC,
                PERSONNEL_NAME: item.BLANK_PERSONNEL_NAME !== undefined ? item.BLANK_PERSONNEL_NAME : item.PERSONNEL_NAME,
                CREATED_BY: _this14._objBudget.USER.USER_ID,
                CREATED_DT: new Date(),
                INPUT_AMT: item.INPUT_AMT_TMP.replace(/,/g, ''),
                EPISODES: _this14._objBudget.HEADER.EPISODES,
                CONFIDENTIAL: item.CONFIDENTIAL_TMP === undefined ? 0 : item.CONFIDENTIAL_TMP == true ? 1 : 0,
                PER_TAPING_DAY_RATE: 0,
                PERSONNEL_CLASS_TYPE: _this14.getPersonnelClassType(),
              ...
              varTalentToEdit.TAPING_DAY_CNT = _this14._objBudget.HEADER.TAPING_DAYS;
              ...
              varTalentToEdit.LAST_UPDATED_BY = _this14._objBudget.USER.USER_ID;
              varTalentToEdit.LAST_UPDATED_DT = new Date();
              varTalentToEdit.INPUT_AMT = item.INPUT_AMT_TMP.replace(/,/g, '');
              varTalentToEdit.EPISODES = _this14._objBudget.HEADER.EPISODES;
              ...
              if (item.TALENT_MANAGER !== undefined) {
                ...
                if (item.BDGT_TMPL_DTL_ID_LINK_TMP !== undefined) {
                  var varCheckTalent = _this14._PersonnelTM.find(function (allTalent) {
          ...
          (0, _entityManagerFactory.EntityManager)().saveChanges().then(function (success) {
            _this14.fnCheckBudget(_this14._objBudget.HEADER.BDGT_TMPL_ID);
            _toastr2.default.success("Succesfully Saved", _this14.toPersonModel.USE);

            if (tag == 1) _this14.fnSequenceDispatch();
          }, function (fail) {
    ...
    PersonnelCustomElement.prototype.fnIndivMstr = function fnIndivMstr() {
      ...
      this.dialogService.open({
        ...
        if (!response.wasCancelled) {
          _this15.PassedIndiv(response.output);
        } else {}
      });
    };
    ...
    PersonnelCustomElement.prototype.fnModalJob = function fnModalJob() {
      ...
      this.dialogService.open({
        ...
        if (!response.wasCancelled) {
          _this16.passJob(response.output);
        } else {}
      });
    };
    ...
    PersonnelCustomElement.prototype.fnModalPaymentTerm = function fnModalPaymentTerm() {
      ...
      this.dialogService.open({
        ...
        if (!response.wasCancelled) {
          _this17.passTerm(response.output);
        } else {}
      });
    };
    ...
    PersonnelCustomElement.prototype.fnIndivMstrManager = function fnIndivMstrManager() {
      ...
      this.dialogService.open({
        ...
        if (!response.wasCancelled) {
          _this18.fnPassedPersonnels(response.output);
        } else {}
      });
    };
...
define('modals/buh-program-dialog',['exports', '../masterfiles', 'multi-observer', 'aurelia-framework', '../helpers', 'underscore', 'jquery', '../entity-manager-factory', 'toastr', 'modals/modal-wizard', 'objBudget', 'aurelia-dialog'], function (exports, _masterfiles, _multiObserver, _aureliaFramework, _helpers, _underscore, _jquery, _entityManagerFactory, _toastr, _modalWizard, _objBudget, _aureliaDialog) {
	'use strict';
	...
	var buhProgramDialog = exports.buhProgramDialog = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _aureliaFramework.ObserverLocator, Element, _modalWizard.ModalWizard, _objBudget.objBudget, _aureliaDialog.DialogController), _dec(_class = function () {
		function buhProgramDialog(multiObserver, observerLocator, Element, ModalWizard, objBudget, controller) {
			...
			var _query = (0, _entityManagerFactory.EntityQuery)().from('PROGRAM_MSTR').where(breeze.Predicate.and(this.currPredicate)).select('PROGRAM_CD,PROGRAM_TITLE,PROGRAM_ID,BUH_PERSONNEL_ID');
			(0, _entityManagerFactory.EntityManager)().executeQuery(_query).then(function (success) {
				_this._programs = success.results;
			}, function (failed) {
...
define('modals/buh-search',['exports', '../masterfiles', 'multi-observer', 'aurelia-framework', '../helpers', 'underscore', 'jquery', '../entity-manager-factory', 'toastr', 'objBudget', 'aurelia-dialog'], function (exports, _masterfiles, _multiObserver, _aureliaFramework, _helpers, _underscore, _jquery, _entityManagerFactory, _toastr, _objBudget, _aureliaDialog) {
	'use strict';
	...
	var buhSearch = exports.buhSearch = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _aureliaFramework.ObserverLocator, Element, _objBudget.objBudget, _aureliaDialog.DialogController), _dec(_class = function () {
		...
		buhSearch.prototype.onSpeculateProp = function onSpeculateProp(newValue, oldValue) {
			...
			_underscore2.default.each(this._rBUH_SEARCH.querySelectorAll('input'), function (all) {
				...
				if (varOb.getValue() != undefined && varOb.getValue() != null && varOb.getValue() != "" && varOb.getValue() != "undefined") lstPredicates.push(breeze.Predicate.create(varOb.propertyName.replace('_b', ''), breeze.FilterQueryOp.Contains, varOb.getValue().toUpperCase()));
			...
			setTimeout(function (a) {
				...
				var _query = (0, _entityManagerFactory.EntityQuery)().from('BUH_PERSONNEL').where(breeze.Predicate.and(_this2.currPredicate)).select('BUH_PERSONNEL_ID,OPTIONAL_GLOBAL_ID,FIRST_NAME,MIDDLE_NAME,LAST_NAME, EMAIL_ADDRESS');
				(0, _entityManagerFactory.EntityManager)().executeQuery(_query).then(function (success) {
					tmpVar = [];
...
define('modals/job',['exports', '../masterfiles', 'multi-observer', 'aurelia-framework', '../helpers', 'underscore', 'jquery', '../entity-manager-factory', 'toastr', 'objBudget', 'aurelia-dialog'], function (exports, _masterfiles, _multiObserver, _aureliaFramework, _helpers, _underscore, _jquery, _entityManagerFactory, _toastr, _objBudget, _aureliaDialog) {
	'use strict';
	...
	var job = exports.job = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _aureliaFramework.ObserverLocator, Element, _objBudget.objBudget, _aureliaDialog.DialogController), _dec(_class = function () {
		...
		job.prototype.fnManualFilter = function fnManualFilter(tmpVar) {
			...
			_underscore2.default.each(this._rJOB_TITLE.querySelectorAll('input'), function (all) {
				...
				if (varOb.getValue() != undefined && varOb.getValue() != null && varOb.getValue() != "" && varOb.getValue() != "undefined") _this2.currPredicate.push(breeze.Predicate.create(varOb.propertyName.replace('_b', ''), breeze.FilterQueryOp.Contains, varOb.getValue().toUpperCase()));
...
define('modals/login',['exports', '../masterfiles', 'multi-observer', 'aurelia-framework', 'underscore', 'jquery', '../entity-manager-factory', 'toastr', 'aurelia-http-client', 'modals/modal-wizard', 'objBudget', 'aurelia-dialog', '../settings'], function (exports, _masterfiles, _multiObserver, _aureliaFramework, _underscore, _jquery, _entityManagerFactory, _toastr, _aureliaHttpClient, _modalWizard, _objBudget, _aureliaDialog, _settings) {
	'use strict';
	...
	var login = exports.login = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _aureliaFramework.ObserverLocator, Element, _aureliaHttpClient.HttpClient, _modalWizard.ModalWizard, _objBudget.objBudget, _aureliaDialog.DialogController), _dec(_class = function () {
		function login(multiObserver, observerLocator, Element, httpClient, ModalWizard, objBudget, controller) {
			var _this = this;
			...
			httpClient.configure(function (config) {
				config.withBaseUrl(_settings2.default.ActualCostService + '/search/');
			});

			this._HttpClient = httpClient;

			this._HttpClient.post("get_users").then(function (response) {
				_this._content = JSON.parse(response.content);
			});
		...
		login.prototype.tryLogin = function tryLogin() {
			...
			_jquery2.default.post(_settings2.default.ActualCostService + "/search/Check_User", {
				...
				_this2.loginSuccess(response);
				_this2._ModalWizard.ids.pop();
			});
		};
		...
		login.prototype.loginSuccess = function loginSuccess(response, CALLER) {
			...
			if (response == "") {
				...
				this.controller.ok(JSON.parse(response));
	...
	var program = exports.program = (_dec = (0, _aureliaFramework.inject)(_multiObserver.MultiObserver, _aureliaFramework.ObserverLocator, Element, _objBudget.objBudget, _aureliaDialog.DialogController), _dec(_class = function () {
		...
		program.prototype.onSpeculateProp = function onSpeculateProp(newValue, oldValue) {
			...
			setTimeout(function (a) {
				...
				var _query = (0, _entityManagerFactory.EntityQuery)().from('PROGRAM_MSTR').where(breeze.Predicate.and(_this2.currPredicate)).select('PROGRAM_CD,PROGRAM_TITLE,PROGRAM_ID,BUH_PERSONNEL_ID');
				(0, _entityManagerFactory.EntityManager)().executeQuery(_query).then(function (success) {
					tmpVar = [];
